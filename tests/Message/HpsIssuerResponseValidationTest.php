 ...
 */
class HpsIssuerResponseValidationTest extends TestCase
{
    ...
    {
        $this->assertNotNull(HpsIssuerResponseValidation::checkResponse(null, '02', null));
    }
    ...
    protected function assertExceptionValues($codes, $exceptionCode, $exceptionMessage, $type)
    {
        foreach ($codes as $code) {
            ...
            $this->assertEquals($exceptionCode, $exception->code);
